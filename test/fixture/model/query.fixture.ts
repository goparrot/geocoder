...
export const plainFullFilledGeocodeQueryObject: GeocodeQueryInterface = Object.freeze({
...
export const plainFullFilledReverseQueryObject: ReverseQueryInterface = Object.freeze({
    lat: 40.74185,
    lon: -74,
    limit: Query.DEFAULT_RESULT_LIMIT,
